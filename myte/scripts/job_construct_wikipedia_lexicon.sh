...
LOG=/home/user/project/myte/output_construct_wikipedia_lexicon.txt
exec > "$LOG" 2>&1
...
LANGUAGES=('de' 'el' 'en' 'eo' 'es' 'et' 'eu' 'fa' 'fi' 'fo' 'fr' 'ga' 'gd' 'gl' 'gu' 'ha' 'haw' 'he' 'hi' 'ht' 'hu' 'hy' 'id' 'ig' 'is' 'it' 'ja' 'jv' 'ka' 'kk' 'km' 'kn' 'ko' 'ku' 'ky' 'la' 'lb' 'lo' 'lt' 'lv' 'mg' 'mi' 'mk' 'ml' 'mn' 'mr' 'ms' 'mt' 'my' 'ne' 'nl' 'no' 'ny' 'pa' 'pl' 'ps' 'pt' 'ro' 'ru' 'sd' 'si' 'sk' 'sl' 'sm' 'sn' 'so' 'sq' 'sr' 'st' 'su' 'sv' 'sw' 'ta' 'te' 'tg' 'th' 'tr' 'uk' 'ur' 'uz' 'vi' 'xh' 'yi' 'yo' 'zh' 'zu')
...
for LANG in "${LANGUAGES[@]}"; do
    ...
    /home/user/project/myte/src/construct_wikipedia_lexicon.py \
    --language "$LANG" \
    --lexicon_directory /home/user/project/myte/lexicon_dict \
